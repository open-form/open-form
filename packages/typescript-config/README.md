<p align="center">
  <a href="https://open-form.dev?utm_source=github&utm_medium=typescript_config" target="_blank" rel="noopener noreferrer">
    <picture>
...
<h1 align="center">@open-form/typescript-config</h1>

<div align="center">

[![OpenForm documentation](https://img.shields.io/badge/Documentation-OpenForm-red.svg)](https://docs.open-form.dev?utm_source=github&utm_medium=typescript_config)
...
```json
{
  "extends": "@open-form/typescript-config/base.json"
}
```
...
View the [Changelog](https://github.com/open-form/open-form/blob/main/packages/typescript-config/CHANGELOG.md) for updates.

## Related packages

- [`@open-form/sdk`](../sdk) - OpenForm framework SDK
- [`@open-form/eslint-config`](../eslint-config) - Shared ESLint configuration
