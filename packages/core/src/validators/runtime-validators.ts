...
// Blocks
export const validateField = createValidator('Field')
export const validateAnnex = createValidator('Annex')
export const validateFieldset = createValidator('Fieldset')
export const validateParty = createValidator('Party')
export const validateFormParty = createValidator('FormParty')
export const validateWitnessRequirement = createValidator('WitnessRequirement')
