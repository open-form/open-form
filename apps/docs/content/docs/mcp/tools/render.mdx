---
title: render
description: Render an OpenForm artifact from a verified registry as text, PDF, or DOCX
ogTitle: render — OpenForm MCP
ogDescription: Render an OpenForm artifact from a verified registry using the MCP server
---
