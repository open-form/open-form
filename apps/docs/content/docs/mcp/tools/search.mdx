---
title: search
description: Search OpenForm artifacts and registries by keyword
ogTitle: search — OpenForm MCP
ogDescription: Search OpenForm artifacts and registries by keyword using the MCP server
---
