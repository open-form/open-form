---
title: validate
description: Validate an OpenForm artifact against the schema and logic rules
ogTitle: validate — OpenForm MCP
ogDescription: Validate an OpenForm artifact against the schema and logic rules using the MCP server
---
