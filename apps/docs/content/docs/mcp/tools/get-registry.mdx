---
title: get_registry
description: Get details for a specific OpenForm registry including its artifacts
ogTitle: get_registry — OpenForm MCP
ogDescription: Get details for a specific OpenForm registry using the MCP server
---
