...
description: Browse the OpenForm artifact registry sorted by popularity
ogTitle: list_artifacts — OpenForm MCP
ogDescription: Browse the OpenForm artifact registry sorted by popularity using the MCP server
---
