---
title: get_artifact
description: Get the full OpenForm artifact JSON and metadata
ogTitle: get_artifact — OpenForm MCP
ogDescription: Get the full OpenForm artifact JSON and metadata using the MCP server
---
