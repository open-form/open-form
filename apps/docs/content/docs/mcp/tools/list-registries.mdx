...
description: List OpenForm artifact registries with artifact counts and total installs
ogTitle: list_registries — OpenForm MCP
ogDescription: List OpenForm artifact registries using the MCP server
---
